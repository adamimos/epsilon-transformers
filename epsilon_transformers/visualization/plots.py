...
def create_mse_plot_with_selector_colab(loader, sweeps_dict):
    """
    Create an interactive Dash app with dataset selection capabilities, optimized for Google Colab.
    ...
    Returns:
        JupyterDash: A configured JupyterDash app ready to run with app.run_server(mode='inline')
    """
    import pandas as pd
    import plotly.graph_objects as go
    from jupyter_dash import JupyterDash
    ...
    # Initialize with JupyterDash for Colab compatibility
